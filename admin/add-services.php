...
include('includes/dbconnection.php');//database connection file used to connect code to the db

//whether admin is logged in or not
...
$query->bindParam(':serprice',$serprice,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   //it means that new data has benn add into the table 
   if ($LastInsertId>0) {
