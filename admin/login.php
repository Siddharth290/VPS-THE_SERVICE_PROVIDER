...
if(isset($_POST['login'])) 
  {
    //query to select ID of the user with the matching username and password from the "tbladmin" table.
...
//if the remeber checkbox is selected the it sets the cookies for username and pass
  if(!empty($_POST["remember"])) {
    ...
    //if the user has unchecked it, it deletes any existing cookies for the username and password.
