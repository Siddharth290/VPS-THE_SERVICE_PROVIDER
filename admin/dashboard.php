<!doctype html>
 ...
 <head>
 <title>Online Service Planner - Admin Dashboard</title>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="unread-queries.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    <?php 
                                        //retrieve the number of unread queries from a database using a SELECT query
                                    ...
                                    ?>
                                     ...
                                     <!--displaying the total number of unread queries in the database-->
                       ...
                       <!-- Read Queries--> 
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="read-queries.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                     <?php 
                                        //retrieve the number of read queries from a database using a SELECT query
                                        ...
                                        <!--displaying the total number of read queries in the database-->
