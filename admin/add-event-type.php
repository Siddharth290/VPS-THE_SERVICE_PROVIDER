...
if (strlen($_SESSION['odmsaid']==0)) {
  header('location:logout.php');
    ...
    //if the submit button has been pressed, the new data is being fetched
    if(isset($_POST['submit']))
    {
        //retrives the values of event type and service price
        $etype=$_POST['eventtype'];
        $serprice=$_POST['serprice'];

        $sql="insert into tbleventtype(EventType)values(:etype)";

        //binds the value of eventtype to etype 
        ...
        $LastInsertId=$dbh->lastInsertId();
            ...
            if ($LastInsertId>0) {
                //IF it is sucessfull then it redirects to the add-event.php page
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Online Event booking service - Add Event Type</title>
