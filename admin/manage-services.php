...
// if the delete id id true then item is deleted
if(isset($_GET['delid']))
{
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Online Service Planner - Manage Services</title>
                        ...
                        <div class="block-content block-content-full">
                           ...
                           <!--Display-->
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    <?php
                                    //The code retrieves the data from the tblservice table using an SQL query
                                    ...
                                    <tr>
                                        ...
                                        <!--if it is true the item is deleted-->
