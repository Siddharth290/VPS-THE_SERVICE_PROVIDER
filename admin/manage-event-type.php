...
if(isset($_GET['delid']))
{
    //the code fetches the value of delid and stores it in the $rid variable.
    $rid=intval($_GET['delid']);

    //a SQL statement to delete the record 
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Online Event bokking system - Manage Event Type</title>
