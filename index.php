...
<html lang="en">
<head>
<title>Online Service booking|| Home Page
</title>
				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>We Plan Your Event from Start to Finish with Best Industry Experts</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>We Know how valueable your Time and Event are</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
